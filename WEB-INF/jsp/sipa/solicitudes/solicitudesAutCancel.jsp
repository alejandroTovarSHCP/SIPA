...
<div class="panel panel-default">
	<div class="panel-heading">
		<h1><b>Solicitudes Autorizadas y Canceladas</b></h1>
		<hr class="red">
	</div>
</div>

<html:form modelAttribute="solicitudDTO" id="invocaAutoCancelApp" action="invocaAutoCancelApp.do" acceptCharset="ISO_8859-1">
<table width="60%" align="center">
		<tr><td><fieldset>
		 <legend style="font-size:1.3em"><strong>&nbsp;&nbsp;Búsqueda de Solicitudes Canceladas&nbsp;&nbsp; </strong></legend>
			<table align="center" width="100%">
				...
				<tr>
					...
					<td>
				        ...
				        <fsn:selectList beanName="selectAutoCancel" path="idEstado" appendFilters="false" progress="true" style="width:80%"/>
			         </td>
				</tr>
				<tr>
		...
		<tr><td>
			<table width="100%" align="center">
				<tr align="center">
					<td><fsn:submit value="submit.search" path="consulta" action="solicitudes/invocaAutoCancelApp.do"/></td>
				</tr>
			</table>
		</td></tr>
    </table>
...
<fsn:filter property="tipoConsulta" condition="=" path="tipoConsulta" value="AUT-CAN"/>

<fsn:pagedList service="gob.shcp.sipa.service.SolicitudesService" baseUrl="invocaAutoCancelApp"/>
