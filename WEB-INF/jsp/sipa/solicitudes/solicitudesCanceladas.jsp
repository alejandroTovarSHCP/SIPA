...
<div class="panel panel-default">
	<div class="panel-heading">
		<h1><b>Solicitudes Canceladas</b></h1>
		<hr class="red">
	</div>
</div>

<html:form modelAttribute="solicitudDTO" id="invocaCanceladasApp" action="invocaCanceladasApp.do" acceptCharset="ISO_8859-1">
<table width="60%" align="center">
		...
		<tr><td>
			<table width="100%" align="center">
				<tr align="center">
					<td><fsn:submit value="submit.search" path="consulta" action="solicitudes/invocaCanceladasApp.do"/></td>
				</tr>
			</table>
		</td></tr>
    </table>
...
<fsn:filter property="tipoConsulta" condition="=" path="tipoConsulta" value="CANCELADAS"/>

<fsn:pagedList service="gob.shcp.sipa.service.SolicitudesService" baseUrl="invocaCanceladasApp"/>
