...
<div class="panel panel-default">
	<div class="panel-heading">
		<h1><b>Solicitudes Registradas y Autorizadas</b></h1>
		<hr class="red">
	</div>
</div>

<html:form modelAttribute="solicitudDTO" id="invocaRegAutApp" action="invocaRegAutApp.do" acceptCharset="ISO_8859-1">

<table width="60%" align="center">
		<tr><td><fieldset>
		 <legend style="font-size:1.3em"><strong>&nbsp;&nbsp;Búsqueda de Solicitud&nbsp;&nbsp; </strong></legend>
		...
		<tr><td>
			<table width="100%" align="center">
				<tr align="center">
					<td><fsn:submit value="submit.search" path="consulta" action="solicitudes/invocaRegAutApp.do"/></td>
				</tr>
			</table>
		</td></tr>
    </table>
...
<fsn:pagedList service="gob.shcp.sipa.service.SolicitudesService" baseUrl="invocaRegAutApp" />
...
<display:table name="SolicitudesService" class="displaytag" pagesize="20" id="pe" requestURI="${requestURI}" sort="list" style="text-align:center" export="false">	
	    ...
	    <display:column titleKey="sipa.consulta.solicitudes.columna0" style="text-align:center" media="html">
			<a href="/sipa/solicitudes/invocaValidacionApp.do?idSolicitud=${pe.idSolicitud}&rutaRegreso=${solicitudDTO.rutaRegreso}">
				<img alt="Validar" src='<spring:theme code="detail.gif"/>' height="20" width="20">
			</a>
		</display:column>
