...
<div class="panel panel-default">
	<div class="panel-heading">
		<h1>
			<b>Consulta de Mis Solicitudes</b>
			<hr class="red">
		</h1>
	</div>
</div>

<html:form modelAttribute="solicitudDTO" id="invocaRegistradasApp" action="invocaRegistradasApp.do" acceptCharset="ISO_8859-1">
...
<table width="60%" align="center">
	...
	<tr><td>
		<table width="100%" align="center">
			<tr align="center">
				<td><fsn:submit value="submit.search" path="consulta" action="solicitudes/invocaRegistradasApp.do"/></td>
			</tr>
		</table>
	</td></tr>
</table>
...
<fsn:filter property="misSolicitudes" condition="=" path="misSolicitudes" value="TODAS"/>


<fsn:pagedList service="gob.shcp.sipa.service.SolicitudesService" baseUrl="invocaRegistradasApp" />
