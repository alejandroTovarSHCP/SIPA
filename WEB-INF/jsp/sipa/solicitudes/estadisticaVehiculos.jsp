...
<fsn:filter property="tipoConsulta" condition="=" path="tipoConsulta" value="VEHICULOS"/>
<fsn:pagedList service="gob.shcp.sipa.service.DashBoardService" baseUrl="invocaVehiculosModal" />

<div style="width: 100%;">
  <button style="width: 100%; height: 20px;" onclick="javascript:parent.redirigir('/sipa/servicios/initHistServicios.do')">Vehículos</button>
</div>
...
<display:table name="DashBoardService" class="displaytag" pagesize="20" id="pe" requestURI="${requestURI}" sort="list" style="text-align:center" export="false">	
	    <display:column titleKey="sipa.consulta.dashboard.columna5" property="nombre" maxLength="50" style="text-align:center"/>
