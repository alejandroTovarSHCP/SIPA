	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<table width="100%" cellpadding="5">
				...
				<tr>
		            <td width="20%" class="label">Fechas de uso:</td>
		            <td>
		...
		<div class="panel-body">
			<table>
				<tr class="realizadoEjemplo">
					...
					<td align='center'> <input type="text" name="kmIni" readonly> </td>
					
					<td align='center'> <input type="text" name="kmFin" readonly> </td>
					
					<td align='center'> <input type="text" name="nivelCombustible" readonly> </td>
		...
		<table id="realizados" width="100%">
			<thead>
				<tr>
					...
					<th align='center'><b>Lugar de Destino:</b></<th>
					<th align='center'><b>Hora de llegada:</b></<th>
					<th align='center'><b>Km Ini:</b></<th>
					<th align='center'><b>Km Fin:</b></<th>
					<th align='center'><b>Combustible:</b></<th>
					<th align='center'><b>Operador:</b></<th>
					<th align='center'><b>Vehiculo:</b></<th>
					<th align='center'><b>Solicitud Asociadas:</b></<th>
...
<div class="row">
	<div style="text-align: center">
		<div role="group">
			<br><br><br><br><br>
			<input type="button" value="Enviar a En atención" onclick="javascript:enAtencionSolicitud();">&nbsp;&nbsp;
			<input type="button" value="Atender Solicitud" onclick="javascript:atenderSolicitud();">
...
<script defer type="text/javascript">
	...
	$j(document).ready(function() {
		...
		$j(".botonera > span > a > img").css("height", 25);
		$j(".botonera > span > a > img").css("width", 25);
	});
	...
	function enAtencionSolicitud(){
		if(confirm("Esta seguro que quiere cambiar a 'En atención' la solicitud") == true){
			if(validaRecorridos()){
   				if(validarHoras()){
   					generaSolicitud();
   				}
	...
	function validaRecorridos() {
		origen  	= [];
   		...
   		return validaNulos("idEntidadOrigen", -1) & validaNulos("idMunicipioOrigen", -1) & validaNulos("idOrigen", -1) & validaNulos("salida", "")
   				...
   				& validaNulos("dirOrigenTxt", "") & validaNulos("dirDestinoTxt", "")
   				& validaNulos("kmIni", "") & validaNulos("kmFin", "") & validaNulos("idOperador", -1) & validaNulos("idVehiculo", -1)
   				& validaNulos("idSolCompartida", -1) & validaNulos("nivelCombustible", "");
	}
