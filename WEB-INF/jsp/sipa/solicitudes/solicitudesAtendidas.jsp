...
<div class="panel panel-default">
	<div class="panel-heading">
		<h1><b>Consulta de Solicitudes Atendidas</b></h1>
		<hr class="red">
	</div>
</div>

<html:form modelAttribute="solicitudDTO" id="invocaAtendidasApp" action="invocaAtendidasApp.do" acceptCharset="ISO_8859-1">
<table width="60%" align="center">
<tr><td><fieldset>
 <legend style="font-size:1.3em"><strong>&nbsp;&nbsp;Búsqueda de Solicitudes Atendidas&nbsp;&nbsp; </strong></legend>
...
<tr><td>
	<table width="100%" align="center">
		<tr align="center">
			<td><fsn:submit value="submit.search" path="consulta" action="solicitudes/invocaAtendidasApp.do"/></td>
		</tr>
	</table>
</td></tr>
  </table>
...
<fsn:filter property="tipoConsulta" condition="=" path="tipoConsulta" value="ATENDIDAS"/>

<fsn:pagedList service="gob.shcp.sipa.service.SolicitudesService" baseUrl="invocaAtendidasApp"/>
...
<display:table name="SolicitudesService" class="displaytag" pagesize="20" id="pe" requestURI="${requestURI}" sort="list" style="text-align:center" export="false">	
	    ...
	    <display:column titleKey="sipa.consulta.operadores.columna0" style="text-align:center" media="html">
			<a href="/sipa/solicitudes/invocaSolicitudAtendida.do?idSolicitud=${pe.idSolicitud}&rutaRegreso=${solicitudDTO.rutaRegreso}">
