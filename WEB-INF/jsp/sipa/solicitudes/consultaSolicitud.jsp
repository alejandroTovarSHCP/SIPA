...
<html:form modelAttribute="solicitudDTO" id="solicitudAltaBienes" action="" method="post" enctype="multipart/form-data" acceptCharset="ISO_8859-1">
		...
		<div class="panel-body">
			<table width="100%" cellpadding="5">
				<tr>
		            ...
		            <td>
		            	<fsn:input path="descEstado" uppercase="false" maxlength="24" size="70" readonly="true"/>
		            </td>
		        </tr>
		        ...
		        <c:if test="${solicitudDTO.idEstado >= 5 && solicitudDTO.idEstado <= 12}">
					<tr>
			            <td width="20%" class="label">Cancelada Por:</td>
			            <td>
			            	<fsn:input path="rfcValidador" uppercase="false" maxlength="24" size="30" readonly="true"/>
			            </td>
			        </tr>
				...
				<c:if test="${solicitudDTO.idEstado != 1}">
					<tr>
						...
						<td>
					        ...
					        <fsn:selectList beanName="selectVehiculos" path="idVehiculo" style="width:60%" disabled="true"/>
				         </td>
					</tr>
				</c:if>
				...
				<c:if test="${solicitudDTO.idEstado != 1}">
					<tr id="muestraOperador">
						...
						<td>
				         	<fsn:option key="-1" value="selectList.nonValue" />		      	  
					        <fsn:selectList beanName="selectOperadores" path="idOperador" style="width:60%" disabled="true"/>
				         </td>
					</tr>
				</c:if>
	...
	<c:if test="${solicitudDTO.idEstado == 4}">
	<br><br>
	<div class="panel panel-default">
		<div class="panel-heading">
	...
	<div class="row">
		<div style="text-align: center">
			<br><br><br><br>
			<c:if test="${solicitudDTO.tipoConsulta != 'CONSULTA'}">
				<div id="divEliminar2">
				...
				<input type="button" value="Cancelar" id="idBtnEliminaAux">&nbsp;&nbsp;
			</c:if>
...
<script defer type="text/javascript">
    ...
    $j('#idBtnEliminaAux').click(function(e){
    	$j("#divEliminar2 > span > a")[0].click();
    });
