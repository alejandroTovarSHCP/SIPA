...
<div class="container">
	<div class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading"><h2><b>EDITAR OPERADOR</b></h2></div>
		</div>
	</div>
</div>
   	
<html:form modelAttribute="operadorDTO" id="editaOperador" name="editaOperador" action="" method="post" enctype="multipart/form-data" acceptCharset="ISO_8859-1">
	...
	<table border="0" width="100%">
		...
		<tr>			
			<td colspan=2 align="center">
				...
				<fsn:submit value="Editar" path="editar" action="operadores/editarOperador.do"/>
