...
<input type="hidden" id="kmInicialAux" value=""/>
		...
		<table width="100%" cellpadding="5">
			<tr>
				...
				<td>
					...
					<fsn:selectList beanName="selectVehiIngresoServ" path="vehiculoFk" appendFilters="false" progress="true" style="width:80%"/>
				</td>
			</tr>
			<tr>
